...
The `cospex` packages proposes S4 classes for defining and simulating observations from the conditional spatial extremes (and extensions thereof) of Wadsworth and Tawn. At maturity, it is expected that the package functionalities will include
